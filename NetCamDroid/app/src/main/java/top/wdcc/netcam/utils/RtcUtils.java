...
import top.wdcc.netcam.NetCamApp;
import top.wdcc.netcam.rtc.RtcConnectionObserver;
...
public class RtcUtils {
    ...
    public static PeerConnection createPeerConnection(RtcConnectionObserver observer) {
